...
public class SpaceFXView extends BorderPane {
    ...
    private              ImageView                topKey;
    private              ImageView                rightKey;
    private              ImageView                bottomKey;
    private              ImageView                leftKey;
    private              ImageView                spaceKey;
    ...
    private void init() {
        ...
        topKey    = new ImageView(topKeyImg);
        rightKey  = new ImageView(rightKeyImg);
        bottomKey = new ImageView(bottomKeyImg);
        leftKey   = new ImageView(leftKeyImg);
        spaceKey  = new ImageView(spaceKeyImg);
        sKey      = new ImageView(sKeyImg);
        rKey      = new ImageView(rKeyImg);
        ...
        topKey.setOnMousePressed(mouseHandler);
        topKey.setOnMouseReleased(mouseHandler);
        rightKey.setOnMousePressed(mouseHandler);
        rightKey.setOnMouseReleased(mouseHandler);
        bottomKey.setOnMousePressed(mouseHandler);
        bottomKey.setOnMouseReleased(mouseHandler);
        leftKey.setOnMousePressed(mouseHandler);
        leftKey.setOnMouseReleased(mouseHandler);
        spaceKey.setOnMousePressed(mouseHandler);
        spaceKey.setOnMouseReleased(mouseHandler);
        sKey.setOnMousePressed(mouseHandler);
        sKey.setOnMouseReleased(mouseHandler);
        rKey.setOnMousePressed(mouseHandler);
        rKey.setOnMouseReleased(mouseHandler);
    }
